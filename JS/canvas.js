...
window.addEventListener('load', function () {
  ...
  LoadColorTable(); // Load the color table.
...
// Populate the color picker table with colors specified in the 'colorPalette' array
...
// Set the color of the drawing tool when a color swatch is clicked
